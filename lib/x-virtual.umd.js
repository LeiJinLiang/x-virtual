(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react")) : typeof define === "function" && define.amd ? define(["exports", "react"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["x-virtual"] = {}, global.React));
})(this, function(exports2, r$1) {
  "use strict";
  ...
  var ue = r__default["default"].createContext();
  ue.Consumer;
  var de = r__default["default"].createContext(), he = (de.Consumer, new Z()), pe = ce();
  function fe() {
    return r$1.useContext(ue) || he;
  }
  function me() {
    return r$1.useContext(de) || pe;
  }
  var ve = function() {
    function e2(e3, t2) {
      var n2 = this;
  ...
  var Ge = r__default["default"].createContext();
  Ge.Consumer;
  var Ye = {};
  function qe(e2, t2, n2) {
    ...
    var C, I2 = new se(n2, g2, o ? e2.componentStyle : void 0), P2 = I2.isStatic && c2.length === 0, O = function(e3, t3) {
      return function(e4, t4, n3, r2) {
        ...
        }(Re(t4, r$1.useContext(Ge), a2) || E, t4, o2), y2 = f3[0], g3 = f3[1], S3 = function(e5, t5, n4, r3) {
        ...
        return t4.style && g3.style !== t4.style && (C2.style = v({}, t4.style, {}, g3.style)), C2.className = Array.prototype.concat(c3, h3, S3 !== h3 ? S3 : null, t4.className, g3.className).filter(Boolean).join(" "), C2.ref = w2, r$1.createElement(_2, C2);
      }(C, e3, t3, P2);
    };
    return O.displayName = f2, (C = r__default["default"].forwardRef(O)).attrs = S2, C.componentStyle = I2, C.displayName = f2, C.shouldForwardProp = A2, C.foldedComponentIds = o ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : w, C.styledComponentId = g2, C.target = o ? e2.target : e2, C.withComponent = function(e3) {
  ...
  var styled = He;
  const smoothScroll = (opt) => {
    const { h: h2, ele = window } = opt;
    ...
    function step(timestamp) {
      ...
      if (previousTimeStamp !== timestamp) {
        const y2 = Math.min(5 * elapsed, h2);
        ele.scrollTo(0, y2);
        if (y2 >= h2) {
   ...
   * LICENSE file in the root directory of this source tree.
   */
  var f = r__default["default"], k = Symbol.for("react.element"), l = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, n = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p = { key: true, ref: true, __self: true, __source: true };
  function q(c2, a, g2) {
...
`;
  ...
  line-height: 40px;
`;
  const XVirtual = r$1.forwardRef(({
    itemHeight,
    windowHeight,
    data
  }, ref) => {
    const [scrollTop, setScrollTop] = r$1.useState(0);
    const numItems = data.length;
    const innerHeight = numItems * itemHeight;
    const startIndex = Math.floor(scrollTop / itemHeight);
    const endIndex = Math.min(numItems - 1, Math.floor((scrollTop + windowHeight) / itemHeight));
    const VirtualRef = r$1.useRef(null);
    const items = r$1.useMemo(() => {
      const temp = [];
    ...
    const scrollToIndex = (index) => {
      const h2 = index * itemHeight;
      smoothScroll({
        ele: VirtualRef == null ? void 0 : VirtualRef.current,
        h: h2
      });
    };
    r$1.useImperativeHandle(ref, () => ({
      scrollToIndex
    }));
    return /* @__PURE__ */ jsx(Wrapper, {
      ...
      children: /* @__PURE__ */ jsx(Inner, {
        ...
        children: items.map((item, index) => /* @__PURE__ */ jsx(Item, {
          style: item.style,
          children: item.data
        }, index))
      })
